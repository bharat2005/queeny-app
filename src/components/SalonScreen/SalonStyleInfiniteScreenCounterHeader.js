...
import { useSizeHairStylesBySalonId } from '../../hooks/hairstyleSalon/useSizeHairStylesBySalonId'


const SalonStyleInfiniteScreenCounterHeader = ({salonId}) => {
     const {data} = useSizeHairStylesBySalonId(salonId)
...
export default SalonStyleInfiniteScreenCounterHeader