...
import { useSizeNailStaffsBySalonId } from '../../hooks/hairStylist/useSizeNailStaffsBySalonId'
import Colors from '../../constants/Colors'


const NailSalonStaffsInfiniteScreenCounterHeader = ({salonId}) => {
     const {data} = useSizeNailStaffsBySalonId(salonId)
...
export default NailSalonStaffsInfiniteScreenCounterHeader