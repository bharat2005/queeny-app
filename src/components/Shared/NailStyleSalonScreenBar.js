...
const NailStyleSalonScreenBar = ({salonId}) => {
  return (
...
<Pressable onPress={()=> router.back()} style={{position:'absolute', left:12}}>
        <Entypo name="chevron-thin-left" size={24} onPress={()=> router.back()} color={Colors.MAINPURPLE} />
</Pressable>
...
<View style={{position:'absolute', right:18}}>
        <NailSalonLikeButton salonId={salonId} />
</View>
...
export default NailStyleSalonScreenBar