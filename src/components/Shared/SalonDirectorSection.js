    ...
    <View style={{width:'100%'}}>
                        ...
                        <View style={{width:'100%',paddingVertical:12, paddingHorizontal:14, flexDirection:'row',marginTop:18}}>
                          ...
                          <View style={{height:'100%', width:'30%'}}>
                            <View style={{width:'100%', height:150, borderRadius:8, borderWidth:0.8, borderColor:'lightgray', overflow:'hidden', backgroundColor:'white'}}>

                              <Image source={{uri:data?.director?.image}} style={{height:'80%', width:'80%', backgroundColor:'white', margin:'auto'}}  />
