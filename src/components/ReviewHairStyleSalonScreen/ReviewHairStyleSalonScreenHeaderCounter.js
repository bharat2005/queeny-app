...
import { useSizeHairStyleReviews } from '../../hooks/reviews/useSizeHairStyleReviews'
import MaterialCommunityIcons from '@expo/vector-icons/MaterialCommunityIcons';
import Colors from '../../constants/Colors';



const ReviewHairStyleSalonScreenHeaderCounter = ({salonId, orderTypeArray, setCurrentType, currentType}) => {
  const {data, error} = useSizeHairStyleReviews(salonId)
...
export default ReviewHairStyleSalonScreenHeaderCounter
